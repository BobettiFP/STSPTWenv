...
csv_path = "../../results/csv/test_stsptw_matched.csv"
...
for ax, h in zip(axes, hardness_list):
    ...
    for label, mt, color in [
        ...
        g = sub[sub["model_type"] == mt].sort_values("delay_weight")
        if g.empty:
            continue
        ax.plot(
            g["delay_weight"],
...
plt.savefig("../../results/figures/stsptw_matched_ins_infeasible_triple.png", dpi=200)
plt.show()